...
/**
 * @title JacePreSaleV1
 * @dev $JACE TokenPreSale contract V1
 ...
 */
contract JacePreSaleV1 is ReentrancyGuard {
    ...
    uint constant jaceUSDPriceInWei = 320000000000000000; // $0.32
    ...
    uint minBuyJaceInWei = 30000000000000000000; // 30 JACE

    // Maximum amount of JACE tokens that a user can buy, denominated in wei.
    uint maxBuyJaceInWei = 20000000000000000000000; // 20,000 JACE
    ...
    // Function permitting the claiming of JACE tokens once the lockup period has elapsed.
